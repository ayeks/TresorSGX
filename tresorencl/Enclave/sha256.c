...
void cf_sha256_digest_final(cf_sha256_context *ctx, uint8_t hash[CF_SHA256_HASHSZ])
{
  size_t padbytes;
  uint8_t buf[8];
  uint64_t digested_bits, digested_bytes = ctx->blocks;
  digested_bytes = digested_bytes * CF_SHA256_BLOCKSZ + ctx->npartial;
  digested_bits = digested_bytes * 8;

  padbytes = CF_SHA256_BLOCKSZ - ((digested_bytes + 8) % CF_SHA256_BLOCKSZ);
...
const cf_chash cf_sha224 = {
  CF_SHA224_HASHSZ,
  CF_SHA256_BLOCKSZ,
  (cf_chash_init) cf_sha224_init,
  (cf_chash_update) cf_sha224_update,
  (cf_chash_digest) cf_sha224_digest
};

const cf_chash cf_sha256 = {
  CF_SHA256_HASHSZ,
  CF_SHA256_BLOCKSZ,
  (cf_chash_init) cf_sha256_init,
  (cf_chash_update) cf_sha256_update,
  (cf_chash_digest) cf_sha256_digest
};
